package br.com.jonathan.observabilidade.config;
...
public class ObservabilidadeConfig {
    ...
    LogRecordProcessor otelLogRecordProcessor(){
        return BatchLogRecordProcessor.builder(OtlpGrpcLogRecordExporter.builder().setEndpoint("http://192.168.1.14:4317").build()).build();
    }
}
